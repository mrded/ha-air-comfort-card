      ...
      <div class="card-config">
        ...
        <div class="option">
          ...
          >
            ...
            ${t.map(t=>D`
              <option value=${t} ?selected=${t===e.temperature_entity}>
                ${t}
              </option>
            `)}
          </select>
        ...
        <div class="option">
          ...
          >
            <option value="">Select an entity...</option>
            ${t.map(t=>D`
              <option value=${t} ?selected=${t===e.humidity_entity}>
                ${t}
              </option>
            `)}
          </select>
